...
class testQuestions extends Component {
  ...
  async componentDidMount() {
    console.log("dsajlasbasl: "+JSON.stringify(this.props.navigation.state.params.blocks));
            ...
            <Modal 
              ...
              <View style={{height: 18 * vh, width: '70%', position: 'absolute', alignSelf: 'center', borderRadius: 2*vw, backgroundColor: 'white'}}>
                <View style={{height: 10 * vh, width: '100%', justifyContent: 'center'}}>
                  <Text style={{fontFamily: 'Montserrat-SemiBold', fontSize: 4 * vw, marginLeft: 2 * vw, marginRight: 2 * vw, color: 'black'}}> Are you sure you want to Exit? </Text>
                </View>
